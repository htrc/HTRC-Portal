...
public class Global extends GlobalSettings {
    ...
    public F.Promise<SimpleResult> onError(Http.RequestHeader requestHeader, Throwable throwable) {
        ...
        if(userId != null) {
            ...
            UserManagement. sendMail(PlayConfWrapper.htrcEmail(), PlayConfWrapper.errorHandlingEmail(), "Exception in " + PlayConfWrapper.portalUrl(), "Internal server error in " + PlayConfWrapper.portalUrl() + "\n Date and time in US/ET: " + dateFormat.format(date) + " \n Logged In UserId: " + userId + " \n User Email: " + userEmail + "\n Error: " + throwable.getCause());
        } else {
